...
#ifdef CONFIG_CPU_OVERCLOCK
	{ 1, {  1566000, HFPLL, 1, 0x3A }, L2(15), 1262500 },
	{ 1, {  1620000, HFPLL, 1, 0x3C }, L2(15), 1275000 },
	{ 1, {  1674000, HFPLL, 1, 0x3E }, L2(15), 1287500 },
	{ 1, {  1728000, HFPLL, 1, 0x40 }, L2(15), 1300000 },
	{ 1, {  1782000, HFPLL, 1, 0x42 }, L2(15), 1325000 },
	{ 1, {  1836000, HFPLL, 1, 0x44 }, L2(15), 1350000 },
	{ 1, {  1890000, HFPLL, 1, 0x46 }, L2(15), 1375000 },
#endif /* CONFIG_CPU_OVERCLOCK */
	{ 0, { 0 } }
};
...
#ifdef CONFIG_CPU_OVERCLOCK
	{ 1, {  1566000, HFPLL, 1, 0x3A }, L2(15), 1162500 },
